...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "Measurements.jl is available for Julia 0.7 and later versions, and can be installed with Julia built-in package manager. In a Julia session run the commandsjulia> Pkg.update()\njulia> Pkg.add(\"Measurements\")Older versions are also available for Julia 0.4-0.6."
},
...

{
    ...
    "category": "section",
    "text": "You can print Measurement objects to TeX and LaTeX MIMES (\"text/x-tex\" and \"text/x-latex\"), the ± sign will be rendered with \\pm command:julia> display(\"text/x-tex\", 5±1)\n5.0 \\pm 1.0\n\njulia> display(\"text/x-latex\", pi ± 1e-3)\n3.141592653589793 \\pm 0.001"
},
...

{
    ...
    "category": "section",
    "text": "The powerful integration routine quadgk from QuadGK.jl package is smart enough to support out-of-the-box integrand functions that return arbitrary types, including Measurement:julia> QuadGK.quadgk(x -> exp(x / (4.73 ± 0.01)), 1, 7)\n(14.933307243306032 ± 0.009999988180463411, 0.0 ± 0.010017961523508253)Measurements.jl pushes the capabilities of quadgk further by supporting also Measurement objects as endpoints:julia> QuadGK.quadgk(cos, 1.19 ± 0.02, 8.37 ± 0.05)\n(-0.05857827689796702 ± 0.02576650561689427, 2.547162480937004e-11)Compare this with the expected result:julia> sin(8.37 ± 0.05) - sin(1.19 ± 0.02)\n-0.058578276897966686 ± 0.02576650561689427Also with quadgk correlation is properly taken into account:julia> a = 6.42 ± 0.03\n6.42 ± 0.03\n\njulia> QuadGK.quadgk(sin, -a, a)\n(2.484178227707412e-17 ± 0.0, 0.0)If instead the two endpoints have, by chance, the same nominal value and uncertainty but are not correlated:julia> QuadGK.quadgk(sin, -6.42 ± 0.03, 6.42 ± 0.03)\n(2.484178227707412e-17 ± 0.005786464233000303, 0.0)"
},
...

{
    ...
    "title": "TODO",
    "category": "section",
    "text": "Add pretty printing: optionally print only the relevant significant digits (issue #5)\nOther suggestions welcome :-)"
},
